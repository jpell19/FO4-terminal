...
#big_contour, green_mask = find_biggest_contour(image_green_closed_then_opened)

# Apply bounding rectangles
image_with_rectangle = image_green_closed_then_opened.copy()

img, contours, hierarchy = cv2.findContours(image_green_closed_then_opened, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
...
x,y,w,h = rectangle
cv2.rectangle(output,(x,y),(x+w,y+h),(255,0,9),10)
show(output)
